      ...
      <div className="container relative z-10">
        <div className="flex max-h-[60rem] min-h-svh items-center justify-end py-16 md:py-24 lg:py-28">
          <div className="max-w-md">
            <h1 className="mb-5 text-6xl font-bold text-text-alternative md:mb-6 md:text-9xl lg:text-10xl whitespace-pre-line">
              {heading}
            </h1>
            <p className="text-text-alternative md:text-md whitespace-pre-line">{description}</p>
...
export const Header7Defaults: Props = {
  ...
  buttons: [],
  video: "/This_is_a_202508310005.mp4",
  videoType: "video/mp4",
};
