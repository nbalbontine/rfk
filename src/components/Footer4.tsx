    ...
    <footer id="relume" className="px-[5%] py-12 md:py-18 lg:py-20">
      <div className="container">
        <div className="grid grid-cols-1 items-center justify-center justify-items-center gap-x-[4vw] gap-y-12 pb-12 md:pb-18 lg:grid-cols-[0.25fr_1fr_0.25fr] lg:justify-between lg:gap-y-4 lg:pb-20">
          <a href={logo.url} className="lg:justify-self-start h-9 w-[70px] overflow-hidden">
            <img src={logo.src} alt={logo.alt} className="block max-w-none size-full object-contain" />
          </a>
...
export const Footer4Defaults: Props = {
  logo: {
    url: "#",
    src: "http://localhost:3845/assets/261307b951c361f8f93f70d0dd5caaa5afe741cd.svg",
    alt: "RFK Racing Logo",
  },
  columnLinks: [
    {
